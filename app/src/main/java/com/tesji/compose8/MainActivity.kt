...
fun PantallaPrincipal() {
    ...
    Column() {
        LazyRow() {
            items(256) { indice ->
                Button(
                    ...
                    colors = ButtonDefaults.textButtonColors(containerColor = Color(indice, 0, 0),
                    )
                )
                {
        ...
        LazyRow() {
            items(256) { indice ->
                Button(
                    ...
                    colors = ButtonDefaults.textButtonColors(containerColor = Color(0, indice, 0),
                    )
                )
                {
                    Text(text = "$indice",color= Color.White)
        ...
        LazyRow() {
            items(256) { indice ->
                Button(
                    ...
                    modifier = Modifier.height(100.dp),
                    onClick = { azul = indice },
                    colors = ButtonDefaults.textButtonColors(containerColor = Color(0, 0, indice),
                    )
                )
                {
                    Text(text = "$indice",color= Color.White)
        ...
        Button(
            ...
            onClick = {},
            colors = ButtonDefaults.textButtonColors(containerColor = Color(rojo, verde, azul),
            )
        )
        {
            Column() {
